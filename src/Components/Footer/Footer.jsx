      ...
      <div>
        <div>
          <div className=" h-36 bg-slate-800 flex justify-center">
            <div className="flex items-center">
              ...
              <h1 className="text-white md:text-2xl xl:text-4xl">
                Let's take our relationship to <br />
                the next level your bussines
              </h1>
            </div>
          </div>
          <div className="flex justify-between items-center mx-10 md:mx-16 py-4 md:py-6 border-b-2">
            ...
            <div className=" justify-center items-center md:flex gap-5">
              <h1 className="">Cindy Christine @2023</h1>
